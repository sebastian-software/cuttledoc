...
_Parakeet supports English only. gpt-4o-transcribe values are estimates._
...
| ------------------------- | ----- | ------- | --------- | ------ | ----------- |
| **Parakeet v3** (default) | 6x    | 6.2%    | EN only   | 160 MB | Node.js     |
| **Whisper large-v3**      | 0.9x  | 5.3%    | 99        | 1.6 GB | Node.js     |
| **Phi-4-multimodal**      | 1x    | ~4%     | 8         | 12 GB  | Python, GPU |
