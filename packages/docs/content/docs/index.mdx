...
| ---- | ---------------- | ----------- | ------ | -------------------------- |
| 🥇   | **phi4:14b**     | +52.0%      | 36 t/s | Best quality, DE/ES        |
...
- **phi4:14b** achieves best accuracy, especially for German/Spanish
- **mistral-nemo** offers best speed (60 t/s) with good accuracy
