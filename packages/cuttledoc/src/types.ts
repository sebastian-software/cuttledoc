...
/**
 * Parakeet supported languages (25 languages)
 * Matches parakeet-coreml SUPPORTED_LANGUAGES
 */
...
export type ParakeetLanguage = (typeof PARAKEET_LANGUAGES)[number]

/**
 * Whisper supported languages (99 languages)
 * Subset of whisper-coreml SUPPORTED_LANGUAGES for reference
 */
